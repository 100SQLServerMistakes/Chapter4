...
INSERT INTO ProductSubcategories (ProductCategoryID, ProductSubcategoryName, ProductSubcategoryDescription)
VALUES
...
INSERT INTO ProductTypes (ProductTypeName, ProductTypeDescription)
VALUES
...
INSERT INTO SupplierContacts (SupplierContactFirstName, SupplierContactLastName, SupplierContactEmail)
VALUES
...
INSERT INTO Addresses (Street, City, ZipCode)   --x3 suppliers
VALUES
    ('8648 Columbia Street', 'Beachwood', '44122'),
    ('83 Addison Dr.', 'Westerville', '43081'),
    ('508 Mill Pond Street', 'Clinton Township', '48035') ;

INSERT INTO Suppliers (SupplierName, SupplierContactID, SupplierAddressID)
VALUES
    ('Smithfeilds', 1, 7),
    ('Unknown Engineering', 2, 8),
    ('Knight Rider Curriers', 3, 9) ;

INSERT INTO Products (ProductName, ProductStockLevel, ProductTypeID, ProductSubcategoryID)
VALUES
